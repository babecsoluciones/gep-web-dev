...
$eCodEntidad = $_SESSION['sessionAdmin']['eCodEntidad'];
...
$select = "SELECT cc.* FROM CatClientes cc WHERE cc. eCodCliente IN (SELECT eCodCliente FROM BitEventos WHERE eCodEstatus=8 AND eCodEntidad = $eCodEntidad)";
